...
for (const route of [
  ...
  "proof-graph/index.html",
  "partner-kit/index.html",
...
for (const artifact of [
  ...
  "data/external-feedback-summary.json",
  "proof-graph/index.json",
  "proof-graph/registry.json",
  "proof-graph/schema.json",
  "proof-graph/graphs/evt_2024_0001.json",
  "partner-kit/manifest.json",
  "data/changelog.json",
  ...
  "data/signals.json",
  "data/signal-dossiers.json",
  "data/signal-shadow-review.json",
  "data/institution-identity-index.json",
  "data/signal-eligibility.json",
